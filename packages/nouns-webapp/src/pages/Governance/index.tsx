...
const GovernancePage = () => {
  ...
  const nounSingular = <Trans>nuNoun</Trans>;
  const nounPlural = <Trans>nuNouns</Trans>;
    ...
    <Section fullWidth={false} className={classes.section}>
      <Col lg={10} className={classes.wrapper}>
        ...
        <p className={classes.subheading}>
          <Trans>
            nuNouns govern <span className={classes.boldText}>nuNouns DAO</span>. nuNouns can vote on
        ...
        <Row className={classes.treasuryInfoCard}>
          ...
          <Col className={classes.treasuryInfoText}>
            <Trans>
              This treasury exists for <span className={classes.boldText}>nuNouns DAO</span>{' '}
