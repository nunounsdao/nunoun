...
const Playground: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const traitNames = [
      ['greenGrey','coolGrey', 'warmGrey', 'coolestGrey'],
      ...
      <Container fluid="lg">
        <Row>
          <Col lg={10} className={classes.headerRow}>
            ...
            <h1>
              <Trans>nuPlayground</Trans>
            </h1>
            <p>
              <Trans>
                The nuPlayground was built using the {nounsProtocolLink}. nuNoun's traits are determined by the nuNoun Seed. The seed was generated using {nuNounsAssetsLink} and rendered using the {nounsSDKLink}.
              </Trans>
            </p>
          </Col>
        </Row>
