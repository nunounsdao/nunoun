...
// Wrapper type around nuNoun events.
...
/**
 * Fetch list of ProposalVoteEvents representing the voting history of the given nuNoun
 * @param nounId Id of nuNoun who's voting history will be fetched
 */
const useNounProposalVoteEvents = (nounId: number): NounProfileEventFetcherResponse => {
  ...
  const filteredProposals = proposals.filter((p: Proposal, id: number) => {
    ...
    // Filter props from before the nuNoun was born
...
/**
 * Fetch list of TransferEvents for given nuNoun
 * @param nounId Id of nuNoun who's transfer history we will fetch
 */
...
/**
 * Fetch list of DelegationEvents for given nuNoun
 * @param nounId Id of nuNoun who's transfer history we will fetch
 */
...
/**
 * Fetch list of all events for given nuNoun (ex: voting, transfer, delegation, etc.)
 * @param nounId Id of nuNoun who's history we will fetch
 */
