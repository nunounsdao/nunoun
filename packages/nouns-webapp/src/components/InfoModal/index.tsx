      ...
      <div className={classes.modal}>
        <div className={classes.content}>
          <div className={classes.bidWrapper}>
            ...
            to start the next auction and mint the current nuNoun to the winners wallet. As gas
            ...
            also triggering 2 free nuNoun mints: The nuNounders mint and the nounCubator mint.
            <br />
            <br />
