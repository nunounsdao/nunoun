...
import nounContentClasses from './NouncubatorNounContent.module.css';
...
const NouncubatorNounContent: React.FC<{
  ...
  // Page through nuNouns via keyboard
        ...
        <Row className={auctionActivityClasses.activityRow}>
          ...
          >
            <div className={auctionActivityClasses.section}>
              <Winner winner={''} isNouncubator={true} />
            </div>
          </Col>
        </Row>
      </div>
...
export default NouncubatorNounContent;
